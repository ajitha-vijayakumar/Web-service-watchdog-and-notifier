...
export declare class MTProtoSender {
    ...
    private _authKeyCallback;
    private _updateCallback;
    private _autoReconnectCallback?;
    private _senderCallback;
    private _isMainSender;
     ...
     */
    connect(connection: any, eventDispatch?: any): Promise<boolean>;
    isConnected(): boolean;
    /**
     ...
     */
    send(request: Api.AnyRequest): Promise<unknown>;
    /**
