...
export declare function _photoSizeByteCount(size: FileLike): number | undefined;
export declare function _getEntityPair(entityId: number, entities: Map<number, Entity>, cache: EntityCache, getInputPeerFunction?: any): [Entity?, Api.TypeInputPeer?];
export declare function getInnerText(text: string, entities: Map<number, Api.TypeMessageEntity>): string[];
/**
 ...
 */
export declare function getInputChannel(entity: EntityLike): Api.InputChannel | Api.TypePeer | Api.TypeInputPeer | Entity | import("./define").FullEntity;
/**
 ...
 * @param entity
 */
export declare function getInputUser(entity: EntityLike): Api.InputPeerSelf;
/**
 ...
 */
export declare function getInputPhoto(photo: any): Api.TypePhoto | Api.InputPhotoEmpty;
/**
 ...
 */
export declare function getAttributes(file: File | CustomFile | TypeInputFile, { attributes, mimeType, forceDocument, voiceNote, videoNote, supportsStreaming, thumb }: GetAttributesParams): {
 ...
 */
export declare function getInputMedia(media: any, { isPhoto, attributes, forceDocument, voiceNote, videoNote, supportsStreaming }?: {
    isPhoto?: boolean | undefined;
    attributes?: null | undefined;
    forceDocument?: boolean | undefined;
    voiceNote?: boolean | undefined;
    videoNote?: boolean | undefined;
 ...
 * @returns {Number}
 */
export declare function getAppropriatedPartSize(fileSize: number): 512 | 256 | 128;
export declare function getPeer(peer: EntityLike): Api.TypePeer | Api.TypeInputPeer | Entity | import("./define").FullEntity;
 ...
 * @param addMark
 */
export declare function getPeerId(peer: EntityLike, addMark?: boolean): number;
/**
 * Given a marked ID, returns the original ID and its :tl:`Peer` type.
 * @param markedId
 */
export declare function resolveId(markedId: number): [number, typeof Api.PeerUser | typeof Api.PeerChannel | typeof Api.PeerChat];
/**
 ...
 * @private
 */
export declare function getMessageId(message: any): number | undefined;
/**
 * Parses the given phone, or returns `None` if it's invalid.
 * @param phone
 */
export declare function parsePhone(phone: string | number): string | undefined;
